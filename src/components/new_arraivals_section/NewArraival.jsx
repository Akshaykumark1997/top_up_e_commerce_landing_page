          ...
          {arriavals.slice(0, 4).map((ele) => (
            <div>
              ...
              <div className="flex mt-2">
                <p className="line-through text-left text-[#989898] min-[350px]:text-[10px] min-[250px]:text-[7px] sm:text-[12px]">
                  {ele.priceOld}
                </p>
                <p className="text-[#AC2D11] font-bold min-[350px]:text-[10px] min-[250px]:text-[7px] sm:text-[12px]">{ele.priceNew}</p>
                <p className="text-[#428D00]  min-[350px]:text-[10px] min-[250px]:text-[7px] sm:text-[12px]">({ele.discount})</p>
              </div>
            </div>
          ))}
        </div>
